...
樣板動作（中等速度、大位移）：競技場旗左右擺約 54°（2.2 秒、2.6 秒）；兩個小朋友企喺沙地中間對望，前欄遮住腳，金章掛喺後欄。跳埋一齊約 12px、跳高約 8px，手揮約 80°，接觸有一下小星，2.4 秒一循環，唔會跳出欄外（無武器）。農場風車葉 6.5 秒轉一圈（葉長約 92px）；雞橫行約 88px 並啄低，5 秒。燈塔光帶加光暈 8 秒掃一圈；海鷗飛約 96px，翼拍 0.9 秒，全程 7 秒。
