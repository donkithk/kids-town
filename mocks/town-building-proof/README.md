...
樣板動作（中等速度、大位移）：競技場旗左右擺約 54°（2.2 秒、2.6 秒）；兩個小朋友恢復原本大細（頭半徑 12、身半徑 16），企開喺沙地兩邊，前欄只遮住腳，金章喺後欄左手邊。平時中間留空（身距約 24px），打到先埋去；跳埋一齊約 8px、跳高約 2px，手揮約 70°，頭同後欄頂之間留空，2.4 秒一循環（無武器）。農場風車葉 6.5 秒轉一圈（葉長約 92px）；雞橫行約 88px 並啄低，5 秒。燈塔光帶加光暈 8 秒掃一圈；海鷗飛約 96px，翼拍 0.9 秒，全程 7 秒。
